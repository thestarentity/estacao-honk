...
ai-borg-control = Control cyborg
station-ai-borg-control-success = You took control of cyborg { $name }. Use "Return to core" to leave it.
station-ai-borg-control-occupied = This cyborg is being controlled by someone. You can't take it over.
station-ai-borg-control-busy = You are already controlling a cyborg.
station-ai-borg-control-cooldown = Wait before taking over another cyborg.
...
station-ai-shunt-failed = You can't shunt from here right now.
station-ai-apc-anomalous = Something inside is humming in ways it shouldn't.
